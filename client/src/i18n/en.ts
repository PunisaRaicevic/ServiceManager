export const en = {
  ...
  tasks: {
    ...
    addTask: 'Add Task',
    editTask: 'Edit Task',
    editTaskHint: 'Edit task details',
    editTaskDescription: 'Edit basic task information',
    deleteTask: 'Delete Task',
    deleteTaskHint: 'Delete only this task',
    ...
    printReportHint: 'Print service report',
    ...
    deleteRecurringTaskHint: 'Delete all future instances',
